      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/50 text-base sm:text-lg max-w-3xl">
            ...
            business grow online. <br className="hidden sm:block" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="flex items-center gap-3 p-3 sm:p-4 rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm hover:border-white/20 transition-all duration-300"
            >
              <div
                className={`p-2 sm:p-3 rounded-md ${service.bgColor} transition-all duration-300`}
              >
                <service.Icon
